...
const products = [
  { id: 1, name: 'Black Velvet', growth: 'Foliage', lightLevel: 'medium-light', easyCare: false, airPurifying: true, humidityLevel: 'Tropical', plantType:'Alocasia', petSafe: false, imageSrc: ' ' },
  { id: 2, name: 'Monstera Split-Leaf', growth: 'Foliage', lightLevel: 'medium-light', easyCare: true, airPurifying: true, humidityLevel: 'Tropical', plantType:'Philodendron', petSafe: false, imageSrc: ' ' },
  { id: 3, name: 'Monstera Thai-Constellation', growth: 'Foliage', lightLevel: 'medium-light', easyCare: false, airPurifying: true, humidityLevel: 'Tropical', plantType:'Philodendron', petSafe: false, imageSrc: ' ' },
  { id: 4, name: 'Golden Pothos', growth: 'Vining', lightLevel: 'medium-light', easyCare: true, airPurifying: true, humidityLevel: 'Temperate', plantType:'Pothos', petSafe: false, imageSrc: ' ' },
  { id: 5, name: 'Neon Pothos', growth: 'Vining', lightLevel: 'medium-light', easyCare: true, airPurifying: true, humidityLevel: 'Temperate', plantType:'Pothos', petSafe: false, imageSrc: ' ' },
  { id: 6, name: 'String of Hearts', growth: 'Succulent', lightLevel: 'high-light', easyCare: true, airPurifying: false, humidityLevel: 'arid', plantType:'Succulent', petSafe: true, imageSrc: ' ' },
  { id: 7, name: 'Peperomia Watermelon', growth: 'Foliage', lightLevel: 'medium-light', easyCare: false, airPurifying: true, humidityLevel: 'tropical', plantType:'Peperomia', petSafe: true, imageSrc: ' ' },
  { id: 8, name: 'Pink Princess', growth: 'Vining', lightLevel: 'high-light', easyCare: true, airPurifying: true, humidityLevel: 'tropical', plantType:'Philodendron', petSafe: false, imageSrc: ' ' },
  { id: 9, name: 'White Knight', growth: 'Vining', lightLevel: 'high-light', easyCare: true, airPurifying: true, humidityLevel: 'tropical', plantType:'Philodendron', petSafe: false, imageSrc: ' ' },
  { id: 10, name: 'White Wizard', growth: 'Vining', lightLevel: 'high-light', easyCare: true, airPurifying: true, humidityLevel: 'tropical', plantType:'Philodendron', petSafe: false, imageSrc: ' ' },
  { id: 11, name: 'White Princess', growth: 'Vining', lightLevel: 'high-light', easyCare: true, airPurifying: true, humidityLevel: 'tropical', plantType:'Philodendron', petSafe: false, imageSrc: ' ' },
  { id: 12, name: 'Maidenhair Fern', growth: 'Foliage', lightLevel: 'medium-light', easyCare: true, airPurifying: true, humidityLevel: 'tropical', plantType:'Fern', petSafe: true, imageSrc: ' ' },
  { id: 13, name: 'Hoya Rope', growth: 'Succulent', lightLevel: 'high-light', easyCare: true, airPurifying: false, humidityLevel: 'arid', plantType:'Hoya', petSafe: true, imageSrc: ' ' },
  { id: 14, name: 'Begonia Maculata', growth: 'Foliage', lightLevel: 'medium-light', easyCare: true, airPurifying: true, humidityLevel: 'tropical', plantType:'Begonia', petSafe: false, imageSrc: ' ' },
  { id: 15, name: 'Calathea Orbifolia', growth: 'Foliage', lightLevel: 'medium-light', easyCare: true, airPurifying: true, humidityLevel: 'tropical', plantType:'Calatha', petSafe: true, imageSrc: ' ' }
];
